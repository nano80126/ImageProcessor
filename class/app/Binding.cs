...
namespace MCAJawIns
{
    ...
    public class MsgInformer : INotifyPropertyChanged
    {
        ...
        /// Info Stack Source
        /// </summary>
        public ObservableCollections.ObservableStack<Message> InfoSource { get; set; } = new ObservableCollections.ObservableStack<Message>();

        /// <summary>
        /// Error Stack Source
        /// </summary>
        public ObservableCollections.ObservableStack<Message> ErrSource { get; set; } = new ObservableCollections.ObservableStack<Message>();
        #endregion
